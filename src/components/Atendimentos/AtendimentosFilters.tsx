...
export const AtendimentosFilters: React.FC<AtendimentosFiltersProps> = ({
  ...
  return (
    <div className="space-y-6">
      <div className="glass-card p-6 rounded-[2rem] border border-black/5 dark:border-border bg-card/40 shadow-premium">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-12 h-12 bg-black/[0.02] dark:bg-muted/20 border-black/5 dark:border-border rounded-xl font-medium"
                value={searchValue}
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <Select value={statusFilter} onValueChange={onStatusFilterChange}>
                <SelectTrigger className="h-12 bg-black/[0.02] dark:bg-muted/20 border-black/5 dark:border-border rounded-xl font-bold">
                  <div className="flex items-center gap-3">
                    <Clock className="h-4 w-4 text-primary" />
                    <SelectValue placeholder="Filtrar por status" />
                  </div>
                </SelectTrigger>
                <SelectContent className="rounded-xl border-black/5 dark:border-border">
