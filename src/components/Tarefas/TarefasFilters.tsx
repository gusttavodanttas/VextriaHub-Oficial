      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative group">
          ...
          <Input
            ...
            className="pl-12 h-12 rounded-2xl border-black/5 dark:border-border bg-black/[0.02] dark:bg-muted/30 focus:ring-primary/20"
            value={searchValue}
        ...
        {activeFiltersCount > 0 && (
          <Button 
            ...
            className="whitespace-nowrap h-12 rounded-2xl border-black/5 dark:border-border font-black text-[10px] uppercase tracking-widest gap-2"
          >
            Limpar Filtros
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
          <Select value={priorityFilter} onValueChange={onPriorityFilterChange}>
            <SelectTrigger className="h-12 rounded-2xl border-black/5 dark:border-border bg-black/[0.02] dark:bg-muted/30 font-bold">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" className="flex-1 h-12 rounded-2xl border-black/5 dark:border-border bg-black/[0.02] dark:bg-muted/30 font-black text-[10px] uppercase tracking-widest gap-2">
