...
export const initialClientsData: Array<Record<string, any>> = [ // TODO Fase 2: tipar como Client[] or similar
  {
    id: 1,
    nome: "João Silva",
...
export const initialProcessosData: Array<Record<string, any>> = [ // TODO Fase 2: tipar como Processo[] or similar
  {
...
export const initialAtendimentosData: Array<Record<string, any>> = []; // TODO Fase 2: tipar corretamente